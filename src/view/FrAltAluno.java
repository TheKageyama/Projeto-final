...
public class FrAltAluno extends javax.swing.JDialog {
    ...
    private void btnFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFecharActionPerformed
        this.dispose();
        FrMenu telaConsulta = new FrMenu(null, true);
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            model.CadastroAluno alunoAtual = controller.buscarPorCpf(cpf);
            if (alunoAtual == null) {
                JOptionPane.showMessageDialog(null, "Aluno não encontrado com o CPF informado.");
                return;
            }

            // captura os dados preenchidos (se tiver)
            ...
            // atualiza o a banco de dados
            if (controller.alterarPorCpf(alunoAtual)) {
                JOptionPane.showMessageDialog(null, "Aluno alterado com sucesso!");
                this.dispose(); // Fecha a janela após a alteração
            } else {
